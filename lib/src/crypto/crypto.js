...
var random = require('./random.js'),
  cipher = require('./cipher/index'),
  publicKey = require('./public_key/index'),
  publicKey = require('./public_key/index'),
...
module.exports = {
  ...
  getPrefixRandom: function(algo) {
    return random.rnd.getRandomBytes(cipher[algo].blockSize);
  },
  ...
  generateSessionKey: function(algo) {
    return random.rnd.getRandomBytes(cipher[algo].keySize);
  }
};
