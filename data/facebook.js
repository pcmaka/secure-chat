...
newMessages = function(){
	$(".fbNubFlyout.fbDockChatTabFlyout").each(function(index){
		...
		if(!options.find("a[id='"+currentToDecryptId+"crypto']").length){
			...
			var clearKeysHTML = "<li class='uiMenuItem'><a class='itemAnchor' role='menuitem' tabindex='0' id='"+currentToDecryptId+"remove'><span class='itemLabel fsm' >Public Key löschen</span></a></li>";
			...
			options.html(addPubKeyHTML + ownPrivKeyHTML + ownPublicKeyHTML + clearKeysHTML + trenner + options.html());
